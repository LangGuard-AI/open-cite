...
def main():
    ...
    gui_parser.add_argument('--host', default=None, help='Host to bind to (default: 127.0.0.1)')
    gui_parser.add_argument('--port', type=int, default=None, help='Port to bind to (default: 5000)')
